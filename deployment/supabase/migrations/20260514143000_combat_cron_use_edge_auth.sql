-- =============================================================================
-- Send combat cron admin auth via X-Edge-Auth
-- =============================================================================
-- X-API-Token is now reserved for a user's Supabase Auth JWT. Internal/admin
-- callers present EDGE_API_TOKEN via X-Edge-Auth, and combat_tick validates
-- that header with requireAdminToken().
-- =============================================================================
...
COMMENT ON FUNCTION invoke_combat_tick IS 'Helper that calls combat_tick edge function via pg_net; reads config from app_runtime_config (url, edge_api_token, supabase_anon_key) and sends admin auth via X-Edge-Auth.';
