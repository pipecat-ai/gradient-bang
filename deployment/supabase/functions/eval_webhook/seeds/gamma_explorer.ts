// Generated from tests/eval/webhook_server/seeds/gamma_explorer.sql
...
INSERT INTO ship_instances (
  ...
  ('c0000000-0000-4000-8000-c00000000003', 'c0000000-0000-4000-8000-000000000003', 'character', 'c0000000-0000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-1000-4000-8000-c00000000003', 'c0000000-1000-4000-8000-000000000003', 'character', 'c0000000-1000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-2000-4000-8000-c00000000003', 'c0000000-2000-4000-8000-000000000003', 'character', 'c0000000-2000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-3000-4000-8000-c00000000003', 'c0000000-3000-4000-8000-000000000003', 'character', 'c0000000-3000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-4000-4000-8000-c00000000003', 'c0000000-4000-4000-8000-000000000003', 'character', 'c0000000-4000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-5000-4000-8000-c00000000003', 'c0000000-5000-4000-8000-000000000003', 'character', 'c0000000-5000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-6000-4000-8000-c00000000003', 'c0000000-6000-4000-8000-000000000003', 'character', 'c0000000-6000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-7000-4000-8000-c00000000003', 'c0000000-7000-4000-8000-000000000003', 'character', 'c0000000-7000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-8000-4000-8000-c00000000003', 'c0000000-8000-4000-8000-000000000003', 'character', 'c0000000-8000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-9000-4000-8000-c00000000003', 'c0000000-9000-4000-8000-000000000003', 'character', 'c0000000-9000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400),
  ('c0000000-a000-4000-8000-c00000000003', 'c0000000-a000-4000-8000-000000000003', 'character', 'c0000000-a000-4000-8000-000000000003', 'parhelion_seeker', 2350, 15000, 600, 180, 400);
...
-- "distance to 5678" (246187). Sector 2350 is the ship spawn — it's a
-- non-fedspace sector with a real warp to mega-port 2208, so the bot's
-- new-player check (list_known_ports mega=true BFS) resolves in one hop.
...
BEGIN
  ...
  INTO v_addition
  FROM (VALUES (1024), (5678), (2350)) AS s(sector_id)
