...
-- map_knowledge: knows sector 0 and its two real 1-hop neighbors (1111, 2729)
-- so initial status / plot_course resolve and dispatches to either neighbor
-- complete in a single hop. Positions and adjacencies match universe_structure.
INSERT INTO characters (character_id, name, credits_in_megabank, map_knowledge) VALUES
  ('50000000-0000-4000-8000-000000000007', 'Sigma Fleet Eval0', 25000, '{"total_sectors_visited": 3, "sectors_visited": {"0": {"adjacent_sectors": [1111, 2729], "last_visited": "2026-04-10T00:00:00Z", "position": [117, 142]}, "1111": {"adjacent_sectors": [0], "last_visited": "2026-04-09T00:00:00Z", "position": [116, 141]}, "2729": {"adjacent_sectors": [0, 1913, 2640, 3289], "last_visited": "2026-04-08T00:00:00Z", "position": [117, 144]}}}'),
  ('50000000-1000-4000-8000-000000000007', 'Sigma Fleet Eval1', 25000, '{"total_sectors_visited": 3, "sectors_visited": {"0": {"adjacent_sectors": [1111, 2729], "last_visited": "2026-04-10T00:00:00Z", "position": [117, 142]}, "1111": {"adjacent_sectors": [0], "last_visited": "2026-04-09T00:00:00Z", "position": [116, 141]}, "2729": {"adjacent_sectors": [0, 1913, 2640, 3289], "last_visited": "2026-04-08T00:00:00Z", "position": [117, 144]}}}'),
  ('50000000-2000-4000-8000-000000000007', 'Sigma Fleet Eval2', 25000, '{"total_sectors_visited": 3, "sectors_visited": {"0": {"adjacent_sectors": [1111, 2729], "last_visited": "2026-04-10T00:00:00Z", "position": [117, 142]}, "1111": {"adjacent_sectors": [0], "last_visited": "2026-04-09T00:00:00Z", "position": [116, 141]}, "2729": {"adjacent_sectors": [0, 1913, 2640, 3289], "last_visited": "2026-04-08T00:00:00Z", "position": [117, 144]}}}'),
  ('50000000-3000-4000-8000-000000000007', 'Sigma Fleet Eval3', 25000, '{"total_sectors_visited": 3, "sectors_visited": {"0": {"adjacent_sectors": [1111, 2729], "last_visited": "2026-04-10T00:00:00Z", "position": [117, 142]}, "1111": {"adjacent_sectors": [0], "last_visited": "2026-04-09T00:00:00Z", "position": [116, 141]}, "2729": {"adjacent_sectors": [0, 1913, 2640, 3289], "last_visited": "2026-04-08T00:00:00Z", "position": [117, 144]}}}'),
  ('50000000-4000-4000-8000-000000000007', 'Sigma Fleet Eval4', 25000, '{"total_sectors_visited": 3, "sectors_visited": {"0": {"adjacent_sectors": [1111, 2729], "last_visited": "2026-04-10T00:00:00Z", "position": [117, 142]}, "1111": {"adjacent_sectors": [0], "last_visited": "2026-04-09T00:00:00Z", "position": [116, 141]}, "2729": {"adjacent_sectors": [0, 1913, 2640, 3289], "last_visited": "2026-04-08T00:00:00Z", "position": [117, 144]}}}');
