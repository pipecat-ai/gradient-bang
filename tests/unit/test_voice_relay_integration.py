...
# Onboarding and megaport-resolution integration tests moved to session_init
# coverage (TBD). EventRelay no longer owns is_new_player resolution or the
# onboarding/session.start injection — those happen synchronously in
# session_init.gather_initial_state.
