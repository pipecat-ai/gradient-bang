...
def main():
    ...
    parser.add_argument("character_id", help="Character ID to play as")
    ...
    parser.add_argument(
        "--chat-model", default="gpt-4.1", help="LLM model for chat agent (default: gpt-4.1)"
    )

    parser.add_argument(
        "--task-model", default="gpt-5", help="LLM model for task agent (default: gpt-5)"
    )
