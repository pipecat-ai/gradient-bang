...
- `show_modal: "corporation_details"` opens the corporation details dialog. Use when the user asks to see / show / view their corporation (members, invite code, fleet overview). Do NOT use for narrow questions the voice agent answers directly ("who is in my corp?", "where is our Red Probe?").
...
Show modal example - user wants to see their corporation details:
User: "Show me my corporation."
