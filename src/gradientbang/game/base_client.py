"""Shared async game client base for Gradient Bang."""
...
class BaseAsyncGameClient:
    """Shared client behavior for concrete game API transports."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize shared async game client state.

        Args:
            base_url: Base URL of the game API
        ...
        """
        if not character_id:
            raise ValueError("BaseAsyncGameClient requires a non-empty character_id")
    ...
    def _build_default_summaries(self) -> Dict[str, Callable[[Dict[str, Any]], str]]:
        ...
        def event_query_wrapper(
            data: Dict[str, Any], client: "BaseAsyncGameClient" = self
        ) -> str:
    ...
    async def _request(self, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        raise NotImplementedError("Concrete game clients must implement _request()")
    ...
    async def send_message(
        ...
        """Send a chat message via the game API.
