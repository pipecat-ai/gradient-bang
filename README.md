...
| `TASK_AGENT_EVENT_DRAIN_GRACE_SECONDS` | No       | `0.25`  | Delay before event-triggered task-agent inference so already-delivered sibling events drain through the ordered mailbox. Set `0` to disable. |
