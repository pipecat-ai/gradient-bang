...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap duration-300 ease-in-out text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive outline-offset-2 outline-1.5 outline-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-[length:100%_200%] bg-[position:0_0%] bg-gradient-to-t from-primary-foreground from-50% to-primary to-50% text-primary-foreground hover:bg-[position:0_100%] hover:text-primary transition-[background-position,color] outline-primary hover:outline-solid",
        secondary:
          "bg-primary/[.05] text-secondary-foreground hover:bg-primary hover:text-primary-foreground border-1 border-border hover:border-transparent outline-primary hover:outline-solid transition-[border,background,color]",
        ghost:
