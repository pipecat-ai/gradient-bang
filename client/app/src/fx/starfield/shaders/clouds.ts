...
export const cloudsFragmentShader = `
                ...
                uniform vec3 color;
                uniform vec3 cloudsColorPrimary;
                uniform vec3 cloudsColorSecondary;
                uniform float speed;
                ...
                uniform float cloudsShakeProgress;
                ...
                void main() {
                  ...
                  if (cloudsShakeProgress > 0.0 && performanceMode < 0.5) {
                    ...
                    float shakeWarp = shakeWarpIntensity * 2.0 * cloudsShakeProgress; // Scale by smooth progress
                    uvsFlow += vec2(
                    ...
                    float flowFieldIntensity = cloudsShakeProgress * cloudsShakeProgress; // Square the progress for smoother buildup
                  ...
                  // Secondary layer contribution, now as scalar density and colorized with cloudsColorSecondary
                  ...
                  // Primary layer base as scalar density and colorized with cloudsColorPrimary
                  ...
                  vec3 col = brightness * (baseD * cloudsColorPrimary + c2d * cloudsColorSecondary + starColour.xyz * starScale);
