...
export const FillCrossLoader = ({
  ...
  return (
    <div
      className={cn(
        "absolute inset-0 flex items-center justify-center cross-lines-accent cross-lines-offset-50 bg-subtle-background",
        className
      )}
    >
      <div className="flex flex-col items-center justify-center bg-background py-3 px-6 relative z-10 gap-2 bracket bracket-offset-0 bracket-accent-foreground shadow-xlong">
        <CircleNotchIcon size={28} weight="duotone" className="animate-spin text-terminal" />
        <span className="uppercase text-xs font-medium animate-pulse">
          {message ?? "Initializing"}
        </span>
