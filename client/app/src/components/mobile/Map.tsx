...
import { ArrowRightIcon, WarningDiamondIcon } from "@phosphor-icons/react"
...
export const MobileMap = ({ className, paused }: { className?: string; paused?: boolean }) => {
    ...
    >
      ...
      {coursePlot && uiState !== "combat" && (
        <Card
          size="xxs"
          variant="stripes"
          className="absolute inset-0 z-2 bg-fuel-background/80 stripe-frame-fuel text-xs"
        >
      ...
      <div className="relative w-full z-1">
        {uiState === "combat" && (
          <div className="animate-in fade-in-0 duration-1000 absolute inset-ui-xxs inset-x-0 z-2 bg-background/60 cross-lines-subtle text-destructive-foreground flex flex-col items-center justify-center">
      ...
      <div className="flex flex-row gap-ui-xxs">
        <SectorBadge />
        <PortBadge />
      </div>
    </div>
